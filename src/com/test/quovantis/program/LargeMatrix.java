...
public class LargeMatrix {
	...
	public static void printMaxSubMatrixIndex(int[][] bMatrix, int nRows,
			int nCols) {
		...
		// r-maxSize+1, c-maxSize+1 indicates starting point for required
		// sub-matrix
		System.out.println("Size of the Biggest square sub-matrix: " + maxSize);
		System.out.println("It starts at (" + (r - maxSize + 1) + ","
				+ (c - maxSize + 1) + ")");
	}
}
